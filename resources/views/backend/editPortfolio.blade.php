...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Portfolio</h2>
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                  ...
                                                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                                    <a class="dropdown-item" href="{{ route('edit.portfolio.row',  $Portfolio->id) }}">Edit</a>
                                                                    <a class="dropdown-item" id="delete" href="{{ route('delete.portfolio.row',  $Portfolio->id) }}">Remove</a>
                                                                  </div>
                                                                </div>
                                                            </td>
                                                        </tr>
