                            ...
                            <div class="container">
                                <div class="left_Side">
                                    <div class="profileText">
                                        ...
                                        @endphp
                                        <h2>{{ $info->name }}<br><span>Web Developer</span></h2>
                                    </div>
                                    <div class="contactInfo">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span class="text">{{ $info->address }},{{ $info->city }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="right_Side">
                                            ...
                                            @foreach($experiences as $experience)
                                                <div class="box">
                                                    <div class="year_company">
                                                        <h5 class="mr-2">{{ $experience->startDate }} - {{ $experience->EndDate }}   </h5>
                                                        <h5>{{ $experience->eduName }} </h5>
                                                    </div>
                                                    <div class="text">
                                    ...
                                    <div class="about skills">
                                        ...
                                        @php
                                            $proSkills = App\Models\ProSkill::get();


                                        @endphp
                                        @foreach ($proSkills as $key => $proSkill)
                                            <div class="box">
                                                    <h6>{{ $key + 1 }}. {{ $proSkill->skill }}</h6>
                                                    <div class="percent">
                                                        <div style="width:{{ $proSkill->skill_level }}%;"></div>
                                                    </div>
                                            </div>
                                        @endforeach
