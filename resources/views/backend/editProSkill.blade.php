...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Technical Skills</h2>
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $proSkill->skill }}</td>
                                                            <td>{{ $proSkill->skill_level }}</td>
                                                            <td>
                                                                <div class="dropdown">
                                                                  ...
                                                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                                    <a class="dropdown-item" href="{{ route('edit.proSkill.row',  $proSkill->id) }}">Edit</a>
                                                                    <a class="dropdown-item" id="delete" href="{{ route('delete.proSkill.row',  $proSkill->id) }}">Remove</a>
                                                                  </div>
                                                                </div>
                                                            </td>
                                                        </tr>
