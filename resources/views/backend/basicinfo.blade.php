                                    ...
                                    <div class="pb-3 timeline-item item-primary">
                                        <div class="pl-5">
                                            <div class="mb-1"><strong>@Brown Asher</strong><span
                                                    class="text-muted small mx-2">Just create
                                    ...
                                    <div class="pb-3 timeline-item item-warning">
                                        <div class="pl-5">
                                            <div class="mb-3"><strong>@Hester Nissim</strong><span
                                                    class="text-muted small mx-2">has upload
                                                    new files to</span><strong>Tiny Admin</strong></div>
                                            <div class="row mb-3">
                                                <div class="col"><img src="{{ asset('backend/assets/products/p1.jpg') }}"
                                                        alt="..." class="img-fluid rounded">
                                                </div>
                                                <div class="col"><img src="{{ asset('backend/assets/products/p2.jpg') }}"
                                                        alt="..." class="img-fluid rounded">
                                                </div>
                                                <div class="col"><img src="{{ asset('backend/assets/products/p3.jpg') }}"
                                                        alt="..." class="img-fluid rounded">
                                                </div>
                                                <div class="col"><img src="{{ asset('backend/assets/products/p4.jpg') }}"
                                                        alt="..." class="img-fluid rounded">
                                                </div>
                                            </div>
                                    ...
                                    <div class="pb-3 timeline-item item-warning">
                                        <div class="pl-5">
                                            <div class="mb-3"><strong>@Fletcher Everett</strong><span
                                                    class="text-muted small mx-2">created
                                                    new group for</span><strong>Tiny Admin</strong></div>
                                            <ul class="avatars-list mb-3">
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('backend/assets/avatars/face-1.jpg') }}">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('backend/assets/avatars/face-4.jpg') }}">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('backend/assets/avatars/face-3.jpg') }}">
                                                    </a>
                                                </li>
                                            </ul>
                                            <p class="small text-muted">Front-End Development <span
                                        ...
                                        <div class="pl-5">
                                            ...
                                            <div class="card d-inline-flex mb-2">
                                                <div class="card-body bg-light py-2 px-3"> Lorem ipsum dolor sit amet,
                                                    ...
                                                    elit. Integer dignissim nulla eu quam cursus placerat. Vivamus non odio
                                                    ullamcorper, lacinia
