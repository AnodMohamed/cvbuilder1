        ...
        <div class="row align-items-center h-100">
            ...
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="inputName" class="form-control form-control-lg" name="name"
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="inputEmail" class="form-control form-control-lg" placeholder="Email address"
                           name="email"  name="email" :value="old('email')" required="" autofocus="">
                </div>
                <div class="form-group">
                    <label for="inputPassword" class="sr-only">Password</label>
                    <input type="password" id="inputPassword" class="form-control form-control-lg"
                           name="password" placeholder="Password" :value="__('Password')" required="">
                </div>
                <div class="form-group">
                    ...
                    <input type="password" id="password_confirmation" class="form-control form-control-lg"
                           name="password_confirmation"  placeholder="Comfirm Password" :value="__('Confirm Password')" required="">
                </div>
